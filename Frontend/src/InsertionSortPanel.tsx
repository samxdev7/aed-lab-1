...
// Endpoint base para el algoritmo Baraja / Inserción
const path: string = `${API_KEY}/ordenamiento/insercion`;
    ...
    fetchRequest<number[]>(path, { method: 'POST', body: payload })
      .then((res) => {
        ...
        showNotification(
          ...
          'El arreglo fue ordenado exitosamente con el método Baraja (Inserción).'
        );
      })
      .catch((err) => {
        console.error(err);
  ...
  return (
    <div className="min-h-screen bg-[#0a0d18] text-white flex flex-col justify-between p-8 font-sans">
      ...
      <PanelHeader
        ...
        title="Método Baraja"
        subtitle="Insertion Sort Algorithm"
        colorScheme="purple"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#11162b] border border-purple-500/30 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[160px]">
            <h3 className="text-sm font-bold text-slate-300 mb-4 flex items-center gap-2">
              <Layers className="w-4 h-4 text-purple-400 fill-current" /> Array Desordenado
            </h3>
          ...
          <div className="bg-[#11162b] border border-purple-500/30 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[160px]">
            <h3 className="text-sm font-bold text-slate-300 mb-4 flex items-center gap-2">
              <Layers className="w-4 h-4 text-purple-400 fill-current" /> Array Ordenado
            </h3>
            {sortedArray ? (
              <div className="flex flex-wrap gap-2 justify-center">
